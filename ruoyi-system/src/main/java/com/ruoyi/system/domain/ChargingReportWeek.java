...
/**
 * 周报表对象 charging_report_week
 * 
 * @author ruoyi
 * @date 2023-01-12
 */
public class ChargingReportWeek extends BaseEntity
{
    ...
    @Excel(name = "周起始", width = 30, dateFormat = "yyyy-MM-dd")
    private Date weekStart;

    /** 周结束 */
    @JsonFormat(pattern = "yyyy-MM-dd")
    @Excel(name = "周结束", width = 30, dateFormat = "yyyy-MM-dd")
